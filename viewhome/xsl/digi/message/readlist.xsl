			...
			<head>							
				...
				<script>
					...
					$.hori.showLoading();
						...
						var url = "/view/oamobile/messagesubreadlist/Produce/DigiFlowMobile.nsf/agGetViewData?openagent&amp;login&amp;0.6922244625974295&amp;server=OAMSGPRD/npchina&amp;dbpath=DFMessage/dfmsg_"+itcode+".nsf&amp;view=vwMsgUnRdForMobile&amp;thclass=&amp;page="+npage+"&amp;count="+ncount+"&amp;pageFrom=homepage"
