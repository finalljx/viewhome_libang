...
<xsl:import href="/xsl/pub/scriptCss.xsl" />	
			...
			<head>							
				...
				<script>
					...
					function fetch(){
						...
						var url = "/view/oamobile/messagesublist/Produce/DigiFlowMobile.nsf/agGetMsgViewData?openagent&amp;login&amp;0.6922244625974296&amp;server=OAMSGPRD/npchina&amp;dbpath=DFMessage/dfmsg_"+itcode+".nsf&amp;view=vwMsgUnRdForMobile&amp;thclass=&amp;page="+npage+"&amp;count="+ncount;
	...
	<xsl:template match="viewentry">
		...
		<li>
			<a href="javascript:void(0);" onclick="changepage(encodeURI('/view/oamobile/{$specialxslid}/Produce/DigiFlowMobile.nsf/showform?openform&amp;login&amp;apptype=msg&amp;appserver=OAMSGPRD/npchina&amp;appdbpath=DFMessage/dfmsg_{substring-before(substring-after(//param[@key='dbpath']/@value, 'dfmsg_'), '.nsf')}.nsf&amp;appdocunid={@unid}'))" data-icon="arrow-r" data-iconpos="right">
