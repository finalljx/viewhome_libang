...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
			...
			<head>
				...
				<script>
					...
					function fetch(){
						...
						var url = "/view/oamobile/todosmobilesub/Produce/DigiFlowMobile.nsf/agGetMsgViewData?openagent&amp;login&amp;0.47540903102505816&amp;server="+oaServerName+"&amp;dbpath=DFMessage/dfmsg_"+itcode+".nsf&amp;view=vwTaskUnDoneForMobile&amp;thclass=&amp;page="+npage+"&amp;count="+ncount;
						$.ajax({
							type: "get", url: url,
	...
	<xsl:template match="viewentry">
		...
		<li>
			<a href="javascript:void(0)" onclick="changepage(encodeURI('/view/oamobile/{$specialxslid}/Produce/DigiFlowMobile.nsf/showform?openform&amp;login&amp;apptype=msg&amp;appserver={$oaServerName}&amp;appdbpath=DFMessage/dfmsg_{substring-before(substring-after(//param[@key='dbpath']/@value, 'dfmsg_'), '.nsf')}.nsf&amp;appdocunid={@unid}'))" data-icon="arrow-r" data-iconpos="right">
