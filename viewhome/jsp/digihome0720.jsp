			...
			<div data-role="content" align="center">
				...
				<div class="ui-grid-b" id="divOne">
				   ...
				   <div class="ui-block-c">
						<a href="javascript:void(0);" onclick="$.hori.showLoading();$.hori.loadPage(encodeURI('/view/oa/messagereadlist/Produce/DigiFlowMobile.nsf/agGetMsgViewData?openagent&login&0.6922244625974295&server=<%=request.getParameter("oaServerName")%>&dbpath=DFMessage/dfmsg_<%=request.getParameter("itcode")%>.nsf&view=vwMsgRdForMobile&thclass=&page=1&count=20&pageFrom=homepage'))">
							<img width="68" height="68" src="/view/png/sugon/wdxx.png" />
						</a>
                        <br/>
