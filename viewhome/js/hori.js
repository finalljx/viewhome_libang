...
/*
	_cherryIos
	_cherryAndroid
	@description:负责跟手机通讯用脚本
	@return {brrdge 对象，提供跟手机交互桥接功能}
*/
function _cherryIos(){
...
/*
@descripttion: 根据不同的平台分别初始化cherry
触发horiInit事件
*/
...
var horiPub={
	/*
		@param targetUrl @trype String 目标url 相对路径
		@param componetXmlUrl @type string  容器url 相对路径
	*/
	...
	/*
		@param forceRefresh @type:string  
